...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.تفليش"))
async def _(event):
    await event.delete()
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.اكس او"))
async def _(event):
    bot = 'inlinegamesbot'
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.حجرة ورقة مقص"))
async def _(event):
    bot = 'inlinegamesbot'
    xo = await sedthon.inline_query(bot, "")
    await xo[4].click(
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.سورس"))
async def a(event):
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.تهكير"))
async def a(event):
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.صورته"))
async def _(event):
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.ذاتية"))
async def _(event):
...
@jesthon.on(events.NewMessage(pattern=r"\.ادمن", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء الاسم الوقتي"))
async def _(event):
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.اسم وقتي"))
async def _(event):
    time_name.clear()
    time_name.append("on")
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.انهاء البايو الوقتي"))
async def _(event):
...
@jesthon.on(events.NewMessage(outgoing=True, pattern=r"\.بايو وقتي"))
async def _(event):
    await event.delete()
    if event.fwd_from:
        return
...
async def _(event):
    ...
    await event.edit(f'''
𝐰𝐞𝐥𝐜𝐨𝐦𝐞 𝐭𝐨 𝐜𝐡𝐞𝐜𝐤𝐞𝐫 𝐬𝐨𝐮𝐫𝐜𝐞 jesthon
𝐝𝐞𝐯 : @nnnnnn4nn
𝐜𝐡𝐚𝐧𝐧𝐞𝐥 : @jesthon
𝐫𝐞𝐥𝐞𝐚𝐬𝐞 : 1.5
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id :
        order = await event.reply(' اهلا مطور كارلوس -  @nnnnn4nn')
